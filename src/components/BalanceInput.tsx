  ...
  return (
    <View className="w-full bg-surface rounded-xl p-4">
      ...
      <View className="flex-row mb-4">
        ...
        >
          <Text
            className={`text-base font-medium ${operation === 'increase' ? 'text-primary-content' : 'text-surface-content'}`}
          >
            Aumentar
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text
            className={`text-base font-medium ${operation === 'decrease' ? 'text-primary-content' : 'text-surface-content'}`}
          >
            Diminuir
          </Text>
        </TouchableOpacity>
      ...
      <View className="mb-4">
        ...
        >
          <Text className="text-base text-surface-content">{date.toLocaleDateString()}</Text>
        </TouchableOpacity>
        {showDatePicker && (
