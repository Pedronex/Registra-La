...
CREATE TABLE `__new_config` (
	...
	`company_name` text,
	`gemini_api_key` text,
	`created_at` integer DEFAULT '"2025-09-25T14:37:43.888Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-09-25T14:37:43.888Z"' NOT NULL
);
...
CREATE TABLE `__new_registers` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`type` text NOT NULL,
	`time` text DEFAULT '00:00' NOT NULL,
	`date` text NOT NULL,
